...
@Autonomous(name = "Blue Silver Auto Mode", group = "opMode")
public class BlueSilverAuto extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Thread.sleep(2000);
        /**
         * For this part(move to aliance depo drop marker), I don't have too much time with it.
         * I'll just park to the cater name
         */
        /**
          //turn 45deg
        wheelMotors[0].setPower(1);
